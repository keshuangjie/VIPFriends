...
public class StringBody extends AbstractContentBody {
	 ...
	 * @since 4.1
	 */
	public static StringBody create(final String text, final String mimeType,
	 ...
	 * @param charset
	 *            the character set, may be {@code null}, in which case the
	...
	/**
	 * Create a StringBody from the specified text. The mime type is set to
	 * "text/plain". The hosts default charset is used.
	 * 
	 * @param text
	 *            to be used for the body, not {@code null}
	 * @throws java.io.UnsupportedEncodingException
