...
import com.android.volley.Compatible.mutilpart.content.ContentBody;
...
class HttpMultipart {
	...
	private static void writeField(final MinimalField field,
			final OutputStream out) throws IOException {
	 ...
	 * {@link HttpMultipartMode#BROWSER_COMPATIBLE}
	 * 
	 * @param subType
	 *            mime subtype - must not be {@code null}
	 * @param charset
