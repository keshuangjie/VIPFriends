...
/**
 * AndroidHttpClient 兼容组件 目前不支持<br>
 * https Implementation of the Apache {@link DefaultHttpClient} that is
 * configured with reasonable default settings and registered schemes for
 * Android. Don't create this directly, use the {@link #newInstance} factory
 * method.
 * 
 * <p>
 ...
 * </pre>
 */
public final class AndroidHttpClientComp implements HttpClient {
	 ...
	 */
	public static AndroidHttpClientComp newInstance(String userAgent,
			Context context) {
		...
		schemeRegistry.register(new Scheme("http", PlainSocketFactory
				.getSocketFactory(), 80));
		// SocketFactory aFactory = SSLCertificateSocketFactory
		// .getDefault(SOCKET_OPERATION_TIMEOUT);
		// SSLCertificateSocketFactory.getDefault(SOCKET_OPERATION_TIMEOUT);
		// org.apache.http.conn.ssl.SSLSocketFactory factory= new
		// org.apache.http.conn.ssl.SSLSocketFactory(
		// new SSLCertificateSocketFactory(0, null, true))
		// schemeRegistry.register(new Scheme("https", aFactory, 443));
		//
		// schemeRegistry.register(new Scheme("https",
		// SSLCertificateSocketFactory
		// .getHttpSocketFactory(SOCKET_OPERATION_TIMEOUT, null), 443));
		...
		return new AndroidHttpClientComp(manager, params);
	}
	...
	private AndroidHttpClientComp(ClientConnectionManager ccm, HttpParams params) {
	...
	// HttpEntityEnclosingRequest entityRequest = (HttpEntityEnclosingRequest)
	// request;
